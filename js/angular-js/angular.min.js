...
(function(y) {
    ...
    function hd(a, b) {
        ...
        if (lc.test(a)) {
            d =
                e.appendChild(b.createElement("div"));
    ...
    function lg(a, b) {
        var d = function(c, d) {
            ...
            if (g) {
                ...
                1 < g && (f = pa(f));
                for (var l = 0; l <
                    g; l++) c.isImmediatePropagationStopped() || h(a, c, f[l])
            }
        };
        d.elem = a;
        return d
        ...
        function g(a) {
            ...
            q(a, function(a) {
                ...
                if (!m.get(a)) {
                    m.set(a, !0);
                    try {
                        F(a) ? (c = jc(a), E.modules[a] = c, b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue),
        ...
        function k(a, c) {
            ...
            return {
                invoke: function(a, b, c, d) {
                    ...
                    return d ? (c.unshift(null), new(Function.prototype.bind.apply(a, c))) : a.apply(b,
                        c)
                },
    ...
    function ug(a, b, d, c) {
        ...
        h.url = function(b, d, e) {
            ...
            if (b) {
                ...
                J = b;
                s = e;
                !c.history || k && f ? (k || (w = b), d ? l.replace(b) : k ? (d = l, e = b.indexOf("#"), e = -1 === e ? "" : b.substr(e), d.hash = e) : l.href = b, l.href !== b && (w = b)) : (m[d ? "replaceState" :
                    "pushState"](e, "", b), g());
                w && (w = b);
                return h
            }
    ...
    function $c(a, b) {
        ...
        var f = {},
            ...
            m = /^(on[a-z]+|formaction)$/,
            p = R();
        this.directive = function ic(b,
            d) {
            hb(b, "name");
            Ha(b, "directive");
            F(b) ? (c(b), hb(d, "directiveFactory"), f.hasOwnProperty(b) || (f[b] = [], a.factory(b + "Directive", ["$injector", "$exceptionHandler", function(a, c) {
                var d = [];
                q(f[b], function(g, f) {
                    try {
                        var h = a.invoke(g);
            ...
            function(a, b, c, e, p, V, O, qa, L, r) {
                ...
                function ba(a, b, c, d, e) {
                    ...
                    return function(b, c, d) {
                        ...
                        f || (f = (d = d && d[0]) ? "foreignobject" !== ya(d) && ha.call(d).match(/SVG/) ? "svg" :
                            "html" : "html");
                ...
                function Sa(a, b, c, d, e, g) {
                    function f(a, c, d, e) {
                        ...
                        m = 0;
                        for (p = h.length; m < p;) k = H[h[m++]], c = h[m++], g = h[m++], c ? (c.scope ? (l = a.$new(), ba.$$addScopeInfo(z(k), l)) : l = a, n = c.transcludeOnThisElement ? Qa(a,
                            c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? Qa(a, b) : null, c(g, l, k, d, n)) : g && g(a, k.childNodes, void 0, e)
                    }
                ...
                function sc(a,
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            "input" === f &&
                                "hidden" === a.getAttribute("type") && a.setAttribute("autocomplete", "off");
                            if (!Ka) break;
                            g = a.className;
                            G(g) && (g = g.animVal);
                            if (F(g) && "" !== g)
                ...
                function Y(a, b, d, e, g, f, h, k, l) {
                    ...
                    function p(a, e, g, f, l) {
                        ...
                        O && (ba.$$addScopeInfo(L, s, !0, !(A && (A === O || A === O.$$originalDirective))), ba.$$addScopeClass(L, !0), s.$$isolateBindings = O.$$isolateBindings, t = oa(e, f, s, s.$$isolateBindings, O), t.removeWatches && s.$on("$destroy", t.removeWatches));
                        for (n in E) {
                            t = w[n];
                            v = E[n];
                            ...
                            if (B) {
                                ...
                                var r = v();
                                r !== v.instance && (v.instance = r, L.data("$" + t.name + "Controller", r), v.bindingInfo.removeWatches && v.bindingInfo.removeWatches(),
                                    v.bindingInfo = oa(T, f, v.instance, Ib, t))
                            } else v.instance = v(), L.data("$" + t.name + "Controller", v.instance), v.bindingInfo = oa(T, f, v.instance, Ib, t)
                        }
                        q(w, function(a, b) {
                            var c = a.require;
                        ...
                        n = 0;
                        for (t = h.length; n < t; n++) v = h[n], wa(v, v.isolateScope ? s : e, L, f, v.require && W(v.directiveName, v.require, L, E), V);
                        var ua = e;
                    ...
                    l = l || {};
                    for (var n = -Number.MAX_VALUE, H = l.newScopeDirective, w = l.controllerDirectives, O = l.newIsolateScopeDirective, A = l.templateDirective, s = l.nonTlbTranscludeDirective,
                            T = !1, E = !1, qa = l.hasElementTranscludeDirective, v = d.$$element = z(b), t, L, V, r = e, ua, la = !1, u = !1, y, Ca = 0, Oa = a.length; Ca < Oa; Ca++) {
                        t = a[Ca];
                        var Pa = t.$$start,
                            D = t.$$end;
                        Pa && (v = rd(b, Pa, D));
                        ...
                        if (!la && (t.replace && (t.templateUrl || t.template) || t.transclude && !t.$$tlb)) {
                            ...
                            la = !0
                        }!t.templateUrl && t.controller && (w = w || R(), $("'" + L + "' controller", w[L], t, v), w[L] = t);
                        if (y = t.transclude)
                        ...
                        for (var p = 0, n = h.length; p < n; p++)
                            if (c = h[p], (x(g) || g > c.priority) && -1 !== c.restrict.indexOf(e)) {
                                ...
                                if (!c.$$bindings) {
                                    ...
                                    if (t.bindToController &&
                                        !H.controller) throw aa("noctrl", K);
                                    m = m.$$bindings = t;
                ...
                function da(a, b) {
                    ...
                    q(b, function(b, e) {
                        a.hasOwnProperty(e) || "$" === e.charAt(0) || (a[e] = b, "class" !==
                            e && "style" !== e && (d[e] = c[e]))
                    })
                }
                ...
                function ia(a, b, d, g, f, h, k, l) {
                    ...
                    return function(a, b, c, d, e) {
                        a = e;
                        b.$$destroyed || (m ? m.push(b, c, d, a) : (p.transcludeOnThisElement && (a = Qa(b,
                            p.transclude, e)), p(n, b, c, d, a)))
                    }
                }
    ...
    function Cd(a, b, d) {
        if (Eg.test(a)) throw kb("badpath", a);
        var c = "/" !== a.charAt(0);
        c && (a = "/" + a);
        a = ma(a);
        ...
        this.$get = ["$exceptionHandler", "$templateCache", "$http", "$q", "$sce", function(b, d, c, e, f) {
            function g(k, h) {
                ...
                return c.get(k, P({
                    ...
                    h || (a = Kg("tpload", k, a.status, a.statusText), b(a));
                    return e.reject(a)
                })
            }
    ...
    function Td(a) {
        ...
        return function(c, d, f) {
            ...
            for (; d;)(l = Ug.exec(d)) ? (k = db(k, l, 1), d = k.pop()) : (k.push(d), d = null);
    ...
    function Rb(a, b) {
        return function(d, c) {
            ...
            if (F(d)) {
                ...
                if (Wg.test(d)) return new Date(d);
                a.lastIndex = 0;
    ...
    function fe(a) {
        ...
        a.$parsers.push(function(b) {
            ...
            if (Xg.test(b)) return parseFloat(b)
        });
        a.$formatters.push(function(b) {
            if (!a.$isEmpty(b)) {
                if (!Y(b)) throw pb("numfmt",
                    b);
                b = b.toString()
            }
            return b
        ...
        on: function(a, b, d, c) {
            ...
            if (kc(a)) {
                ...
                for (var g = c.length, k = function(b, c, g) {
                        var k = e[b];
                        k || (k = e[b] = [], k.specialHandlerWrapper = c, "$destroy" ===
                            b || g || a.addEventListener(b, f));
                        k.push(d)
                    }; g--;) b = c[g], Ab[b] ? (k(Ab[b], ng), k(b, void 0, !0)) : k(b)
            }
        },
        off: jd,
        one: function(a, b, d) {
    ...
    gb.$$annotate = function(a, b, d) {
        ...
        if ("function" === typeof a) {
            if (!(c = a.$inject)) {
                c = [];
                if (a.length) {
                    if (b) throw F(d) && d || (d = a.name || sg(a)), Aa("strictdi", d);
                    b = pd(a);
                    q(b[1].split(ch),
                        function(a) {
    ...
    var pe = {
        ...
        Qe = ["$interpolate", "$compile", function(a,
            b) {
            return {
                compile: function(d) {
                    b.$$addBindingClass(d);
                    ...
                    return function(c, e, m, p, n) {
                        ...
                        c.$watch(f, function(f) {
                            ...
                            f ? (a(f, !0).then(function(a) {
                                ...
                                c.$$destroyed || w !== q || (s(), c.$emit("$includeContentError", f))
    ...
    Sb.prototype = {
        ...
        $$runValidators: function(a, b, d) {
            ...
            (function() {
                ...
                else return h.$$parserValid || (q(h.$validators, function(a, b) {
                    f(b, null)
    ...
    Mc.prototype = {
        ...
        createChild: function(a) {
            ...
            a = P({}, a);
            q(a, function(d, c) {
                "$inherit" === d ? "*" === c ? b = !0 : (a[c] = this.$$options[c], "updateOn" === c && (a.updateOnDefault = this.$$options.updateOnDefault)) : "updateOn" === c && (a.updateOnDefault = !1, a[c] = Q(d.replace(lh, function() {
                    a.updateOnDefault = !0;
                    return " "
                })))
            }, this);
                    ...
                    post: function(d, k, h, l) {
                        ...
                        v ? (n.writeValue = function(a) {
                            ...
                            q(a, function(a) {
                                ...
                                !a.disabled && b.push(s.getViewValueFromOption(a))
                            });
                            return b
                        ...
                        l && (a(n.emptyOption)(d), k.prepend(n.emptyOption), 8 === n.emptyOption[0].nodeType ? (n.hasEmptyOption = !1, n.registerOption = function(a, b) {
                            "" === b.val() && (n.hasEmptyOption = !0, n.emptyOption = b, n.emptyOption.removeClass("ng-scope"), r.$render(), b.on("$destroy",
                                function() {
                        ...
                        d.$watchCollection(x.getWatchables, function() {
                            ...
                            s.items.forEach(function(a) {
                                ...
                                if (u(a.group)) {
                                    b = d[a.group];
                                    b || (b = f.cloneNode(!1), y.appendChild(b), b.label = null === a.group ? "null" : a.group, d[a.group] = b);
                                    var c = e.cloneNode(!1);
                                    b.appendChild(c);
                                    p(a, c)
                    ...
                    return function(a, d, f, g, l) {
                        ...
                        a.$watchCollection(p, function(f) {
                            ...
                            if (ja(f)) F = f, p = s || x;
                                ...
                                for (G in p =
                                    s || z, F = [], f) ra.call(f, G) && "$" !== G.charAt(0) && F.push(G);
                            w = F.length;
                            G = Array(w);
                            for (g = 0; g < w; g++)
